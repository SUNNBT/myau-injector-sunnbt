...
public class Xray extends Module {
            ...
            if (mc.gameSettings.thirdPersonView == 0) {
                ...
                vec3 = new Vec3(0.0, 0.0, 0.0)
                        ...
                        .rotateYaw(
                                (float) (
                                        -Math.toRadians(
                                                RenderUtil.lerpFloat(mc.thePlayer.cameraYaw, mc.thePlayer.prevCameraYaw, AccessorMinecraft.getTimer(mc).renderPartialTicks)
                                        )
                                )
                        );
            }
    ...
    public void onEnabled() {
        ForgeCompat.setLightPipelineEnabled(false);
    ...
    public void onDisabled() {
        ForgeCompat.setLightPipelineEnabled(true);
        if (mc.renderGlobal != null) {
            mc.renderGlobal.loadRenderers();
        }
    }
