            ...
            if (!entities.isEmpty()) {
                ...
                for (EntityLivingBase entity : entities) {
                    ...
                    AxisAlignedBB offsetBox = new AxisAlignedBB(
                            expandedBox.minX - entity.posX + (RenderUtil.lerpDouble(entity.posX, entity.lastTickPosX, event.getPartialTicks()) - AccessorRenderManager.getRenderPosX(mc.getRenderManager())),
                            expandedBox.minY - entity.posY + (RenderUtil.lerpDouble(entity.posY, entity.lastTickPosY, event.getPartialTicks()) - AccessorRenderManager.getRenderPosY(mc.getRenderManager())),
                            expandedBox.minZ - entity.posZ + (RenderUtil.lerpDouble(entity.posZ, entity.lastTickPosZ, event.getPartialTicks()) - AccessorRenderManager.getRenderPosZ(mc.getRenderManager())),
                            expandedBox.maxX - entity.posX + (RenderUtil.lerpDouble(entity.posX, entity.lastTickPosX, event.getPartialTicks()) - AccessorRenderManager.getRenderPosX(mc.getRenderManager())),
                            expandedBox.maxY - entity.posY + (RenderUtil.lerpDouble(entity.posY, entity.lastTickPosY, event.getPartialTicks()) - AccessorRenderManager.getRenderPosY(mc.getRenderManager())),
                            expandedBox.maxZ - entity.posZ + (RenderUtil.lerpDouble(entity.posZ, entity.lastTickPosZ, event.getPartialTicks()) - AccessorRenderManager.getRenderPosZ(mc.getRenderManager()))
                    );
